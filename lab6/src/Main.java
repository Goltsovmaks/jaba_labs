...
public class Main {
    public static void main(String[] args) {
        ...
        // фабрика создает два вида музыки - старые и новые
        MusicFactory factory1 = new MusicFactory();
        System.out.println(
                factory1.createOldMusic(titles[0],authors[0],genres[0],oldYear).getDescription()
        );
        System.out.println(
                factory1.createNewMusic(titles[1],authors[1],genres[1],newYear).getDescription()
        );
